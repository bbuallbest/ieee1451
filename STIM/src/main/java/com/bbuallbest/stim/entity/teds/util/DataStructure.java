...
@XmlRootElement
public class DataStructure implements EncodableMarker{

    @XmlElement(name = "calibration-key")
    private int calibrationKey;

    @XmlElement(name = "standart-family")
    private int standartFamily;

    @XmlElement(name = "major-version")
    private int majorVersion;

    @XmlElement(name = "implemented-channels")
