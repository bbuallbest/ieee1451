...
@XmlRootElement
public class Timing implements EncodableMarker{

    @XmlElement(name = "worst-update-time")
    private double worstUpdateTime;

    @XmlElement(name = "worst-reade-time")
    private double worstReadeTime;

    @XmlElement(name = "worst-write-time")
    private double worstWriteTime;

    @XmlElement(name = "worst-sampling-time")
    private double worstSamplingTime;

    @XmlElement(name = "io-response-time")
